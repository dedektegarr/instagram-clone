          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="text-sm flex flex-col">
              <div className="flex gap-2">
                <span className="font-medium">dedektegar</span>
                <span>•</span>
                <span>2d</span>
              </div>
      ...
      <footer className="flex flex-col w-full gap-3">
        ...
        <div className="flex flex-col w-full text-sm">
          <p>
            ...
            nesciunt aspernatur vel, beatae fugiat excepturi voluptate dolore
            quaerat quas recusandae.
          </p>

          <Link href="/" className="text-gray-400 my-2">
            View all 2.840 comments
          </Link>
        </div>
      </footer>
    </article>
